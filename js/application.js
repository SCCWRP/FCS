...
var app = {
  ...
  initialize: function(){
	...
	if( isDevice ){
			...
			//latlon = navigator.geolocation.getCurrentPosition(app.getGPSOnSuccess, app.getGPSOnFailure,{ enableHighAccuracy: true, maximumAge: 3000, timeout: 30000 });
			latlon = navigator.geolocation.getCurrentPosition(app.getGPSOnSuccess, app.getGPSOnFailure,{ enableHighAccuracy: true });
